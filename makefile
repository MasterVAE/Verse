...
DEBUG_FLAGS = -D \
                _DEBUG \
                -ggdb3 \
                -fsanitize=alignment,bool,bounds,enum,float-cast-overflow,float-divide-by-zero,integer-divide-by-zero,leak,$\
...
RELEASE_FLAGS = -O1 -march=native -g -D NDEBUG -flto
